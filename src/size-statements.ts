...
export function createSizeExpression(type: TypeData, propAccess: ts.Expression | undefined): ts.Expression | false {
    ...
    switch (type.type) {
        ...
        case "vector": {
            ...
            if (typeData.lengthType.type == "constant") {
                ...
                lengthExpression = createSizeExpression(typeData.lengthType, factory.createPropertyAccessExpression(
                    propAccess,
                    "length"
                ));
            }
            ...
            switch (typeData.valueType.type) {
                        ...
                        [
                            factory.createArrowFunction(
                                ...
                                factory.createBinaryExpression(
                                    ...
                                    createSizeExpression(typeData.valueType, factory.createIdentifier("b")) || factory.createNumericLiteral(0)
                                )
                            ),
                ...
                default:
                    ...
                    if (!(typeData.valueType.type in sizes)) {
                        throw new Error(`Type ${typeData.valueType.type} does not have an assigned size!`)
                    }
